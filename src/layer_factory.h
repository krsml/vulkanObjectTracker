...
class layer_factory {
    public:
        ...
        bool log_msg(const debug_report_data *debug_data, VkFlags msg_flags, VkObjectType object_type,
            ...
            VulkanTypedHandle null_handle{};
            LogObjectList objlist(null_handle);
            va_end(argptr);
            return LogMsgLocked(debug_data, msg_flags, objlist, vuid_text, str);
        }

        // Pre/post hook point declarations
        bool Information(const std::string &message) {
            return log_msg(vlf_report_data, kInformationBit, VK_OBJECT_TYPE_UNKNOWN, 0,
                           layer_name.c_str(), "%s", message.c_str());
        }

        bool PerformanceWarning(const std::string &message) {
            return log_msg(vlf_report_data, kPerformanceWarningBit, VK_OBJECT_TYPE_UNKNOWN,
                           0, layer_name.c_str(), "%s", message.c_str());
        }

        bool Warning(const std::string &message) {
            return log_msg(vlf_report_data, kWarningBit, VK_OBJECT_TYPE_UNKNOWN, 0,
                           layer_name.c_str(), "%s", message.c_str());
        }

        bool Error(const std::string &message) {
            return log_msg(vlf_report_data, kDebugBit, VK_OBJECT_TYPE_UNKNOWN, 0,
                           layer_name.c_str(), "%s", message.c_str());
        }
        ...
        virtual void PreCallCmdDrawIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) { PreCallApiFunction("vkCmdDrawIndirectCount");};
        virtual void PostCallCmdDrawIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) { PostCallApiFunction("vkCmdDrawIndirectCount");};
        virtual void PreCallCmdDrawIndexedIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) { PreCallApiFunction("vkCmdDrawIndexedIndirectCount");};
        virtual void PostCallCmdDrawIndexedIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) { PostCallApiFunction("vkCmdDrawIndexedIndirectCount");};
        virtual VkResult PreCallCreateRenderPass2(VkDevice device, const VkRenderPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) { PreCallApiFunction("vkCreateRenderPass2"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateRenderPass2(VkDevice device, const VkRenderPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass, VkResult result) { PostCallApiFunction("vkCreateRenderPass2", result); return VK_SUCCESS; };
        virtual void PreCallCmdBeginRenderPass2(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo) { PreCallApiFunction("vkCmdBeginRenderPass2");};
        virtual void PostCallCmdBeginRenderPass2(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo) { PostCallApiFunction("vkCmdBeginRenderPass2");};
        virtual void PreCallCmdNextSubpass2(VkCommandBuffer commandBuffer, const VkSubpassBeginInfo*      pSubpassBeginInfo, const VkSubpassEndInfo*        pSubpassEndInfo) { PreCallApiFunction("vkCmdNextSubpass2");};
        virtual void PostCallCmdNextSubpass2(VkCommandBuffer commandBuffer, const VkSubpassBeginInfo*      pSubpassBeginInfo, const VkSubpassEndInfo*        pSubpassEndInfo) { PostCallApiFunction("vkCmdNextSubpass2");};
        virtual void PreCallCmdEndRenderPass2(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo) { PreCallApiFunction("vkCmdEndRenderPass2");};
        virtual void PostCallCmdEndRenderPass2(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo) { PostCallApiFunction("vkCmdEndRenderPass2");};
        virtual void PreCallResetQueryPool(VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount) { PreCallApiFunction("vkResetQueryPool");};
        virtual void PostCallResetQueryPool(VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount) { PostCallApiFunction("vkResetQueryPool");};
        virtual VkResult PreCallGetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, uint64_t* pValue) { PreCallApiFunction("vkGetSemaphoreCounterValue"); return VK_SUCCESS; };
        virtual VkResult PostCallGetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, uint64_t* pValue, VkResult result) { PostCallApiFunction("vkGetSemaphoreCounterValue", result); return VK_SUCCESS; };
        virtual VkResult PreCallWaitSemaphores(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout) { PreCallApiFunction("vkWaitSemaphores"); return VK_SUCCESS; };
        virtual VkResult PostCallWaitSemaphores(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout, VkResult result) { PostCallApiFunction("vkWaitSemaphores", result); return VK_SUCCESS; };
        virtual VkResult PreCallSignalSemaphore(VkDevice device, const VkSemaphoreSignalInfo* pSignalInfo) { PreCallApiFunction("vkSignalSemaphore"); return VK_SUCCESS; };
        virtual VkResult PostCallSignalSemaphore(VkDevice device, const VkSemaphoreSignalInfo* pSignalInfo, VkResult result) { PostCallApiFunction("vkSignalSemaphore", result); return VK_SUCCESS; };
        virtual VkDeviceAddress PreCallGetBufferDeviceAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PreCallApiFunction("vkGetBufferDeviceAddress"); return 0; };
        virtual VkDeviceAddress PostCallGetBufferDeviceAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PostCallApiFunction("vkGetBufferDeviceAddress"); return 0; };
        virtual uint64_t PreCallGetBufferOpaqueCaptureAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) { PreCallApiFunction("vkGetBufferOpaqueCaptureAddress"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetBufferOpaqueCaptureAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) { PostCallApiFunction("vkGetBufferOpaqueCaptureAddress"); return VK_NULL_HANDLE; };
        virtual uint64_t PreCallGetDeviceMemoryOpaqueCaptureAddress(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) { PreCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddress"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetDeviceMemoryOpaqueCaptureAddress(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) { PostCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddress"); return VK_NULL_HANDLE; };
        ...
        virtual VkResult PreCallCreateRenderPass2KHR(VkDevice device, const VkRenderPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) { PreCallApiFunction("vkCreateRenderPass2KHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateRenderPass2KHR(VkDevice device, const VkRenderPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass, VkResult result) { PostCallApiFunction("vkCreateRenderPass2KHR", result); return VK_SUCCESS; };
        virtual void PreCallCmdBeginRenderPass2KHR(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo) { PreCallApiFunction("vkCmdBeginRenderPass2KHR");};
        virtual void PostCallCmdBeginRenderPass2KHR(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo) { PostCallApiFunction("vkCmdBeginRenderPass2KHR");};
        virtual void PreCallCmdNextSubpass2KHR(VkCommandBuffer commandBuffer, const VkSubpassBeginInfo*      pSubpassBeginInfo, const VkSubpassEndInfo*        pSubpassEndInfo) { PreCallApiFunction("vkCmdNextSubpass2KHR");};
        virtual void PostCallCmdNextSubpass2KHR(VkCommandBuffer commandBuffer, const VkSubpassBeginInfo*      pSubpassBeginInfo, const VkSubpassEndInfo*        pSubpassEndInfo) { PostCallApiFunction("vkCmdNextSubpass2KHR");};
        virtual void PreCallCmdEndRenderPass2KHR(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo) { PreCallApiFunction("vkCmdEndRenderPass2KHR");};
        virtual void PostCallCmdEndRenderPass2KHR(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo) { PostCallApiFunction("vkCmdEndRenderPass2KHR");};
        ...
        virtual VkResult PreCallEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, uint32_t* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions) { PreCallApiFunction("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, uint32_t* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions, VkResult result) { PostCallApiFunction("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR", result); return VK_SUCCESS; };
        virtual void PreCallGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(VkPhysicalDevice physicalDevice, const VkQueryPoolPerformanceCreateInfoKHR* pPerformanceQueryCreateInfo, uint32_t* pNumPasses) { PreCallApiFunction("vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR");};
        virtual void PostCallGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(VkPhysicalDevice physicalDevice, const VkQueryPoolPerformanceCreateInfoKHR* pPerformanceQueryCreateInfo, uint32_t* pNumPasses) { PostCallApiFunction("vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR");};
        virtual VkResult PreCallAcquireProfilingLockKHR(VkDevice device, const VkAcquireProfilingLockInfoKHR* pInfo) { PreCallApiFunction("vkAcquireProfilingLockKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallAcquireProfilingLockKHR(VkDevice device, const VkAcquireProfilingLockInfoKHR* pInfo, VkResult result) { PostCallApiFunction("vkAcquireProfilingLockKHR", result); return VK_SUCCESS; };
        virtual void PreCallReleaseProfilingLockKHR(VkDevice device) { PreCallApiFunction("vkReleaseProfilingLockKHR");};
        virtual void PostCallReleaseProfilingLockKHR(VkDevice device) { PostCallApiFunction("vkReleaseProfilingLockKHR");};
        ...
        virtual VkResult PreCallGetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, uint64_t* pValue) { PreCallApiFunction("vkGetSemaphoreCounterValueKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, uint64_t* pValue, VkResult result) { PostCallApiFunction("vkGetSemaphoreCounterValueKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallWaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout) { PreCallApiFunction("vkWaitSemaphoresKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallWaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout, VkResult result) { PostCallApiFunction("vkWaitSemaphoresKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallSignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfo* pSignalInfo) { PreCallApiFunction("vkSignalSemaphoreKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallSignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfo* pSignalInfo, VkResult result) { PostCallApiFunction("vkSignalSemaphoreKHR", result); return VK_SUCCESS; };
        virtual VkDeviceAddress PreCallGetBufferDeviceAddressKHR(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PreCallApiFunction("vkGetBufferDeviceAddressKHR"); return 0; };
        virtual VkDeviceAddress PostCallGetBufferDeviceAddressKHR(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PostCallApiFunction("vkGetBufferDeviceAddressKHR"); return 0; };
        virtual uint64_t PreCallGetBufferOpaqueCaptureAddressKHR(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) { PreCallApiFunction("vkGetBufferOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetBufferOpaqueCaptureAddressKHR(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) { PostCallApiFunction("vkGetBufferOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PreCallGetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) { PreCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
        virtual uint64_t PostCallGetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) { PostCallApiFunction("vkGetDeviceMemoryOpaqueCaptureAddressKHR"); return VK_NULL_HANDLE; };
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCreateDeferredOperationKHR(VkDevice device, const VkAllocationCallbacks* pAllocator, VkDeferredOperationKHR* pDeferredOperation) { PreCallApiFunction("vkCreateDeferredOperationKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateDeferredOperationKHR(VkDevice device, const VkAllocationCallbacks* pAllocator, VkDeferredOperationKHR* pDeferredOperation, VkResult result) { PostCallApiFunction("vkCreateDeferredOperationKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallDestroyDeferredOperationKHR(VkDevice device, VkDeferredOperationKHR operation, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyDeferredOperationKHR");};
        virtual void PostCallDestroyDeferredOperationKHR(VkDevice device, VkDeferredOperationKHR operation, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyDeferredOperationKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual uint32_t PreCallGetDeferredOperationMaxConcurrencyKHR(VkDevice device, VkDeferredOperationKHR operation) { PreCallApiFunction("vkGetDeferredOperationMaxConcurrencyKHR"); return VK_NULL_HANDLE; };
        virtual uint32_t PostCallGetDeferredOperationMaxConcurrencyKHR(VkDevice device, VkDeferredOperationKHR operation) { PostCallApiFunction("vkGetDeferredOperationMaxConcurrencyKHR"); return VK_NULL_HANDLE; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallGetDeferredOperationResultKHR(VkDevice device, VkDeferredOperationKHR operation) { PreCallApiFunction("vkGetDeferredOperationResultKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetDeferredOperationResultKHR(VkDevice device, VkDeferredOperationKHR operation, VkResult result) { PostCallApiFunction("vkGetDeferredOperationResultKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallDeferredOperationJoinKHR(VkDevice device, VkDeferredOperationKHR operation) { PreCallApiFunction("vkDeferredOperationJoinKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallDeferredOperationJoinKHR(VkDevice device, VkDeferredOperationKHR operation, VkResult result) { PostCallApiFunction("vkDeferredOperationJoinKHR", result); return VK_SUCCESS; };
#endif
        virtual VkResult PreCallGetPipelineExecutablePropertiesKHR(VkDevice                        device, const VkPipelineInfoKHR*        pPipelineInfo, uint32_t* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties) { PreCallApiFunction("vkGetPipelineExecutablePropertiesKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetPipelineExecutablePropertiesKHR(VkDevice                        device, const VkPipelineInfoKHR*        pPipelineInfo, uint32_t* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties, VkResult result) { PostCallApiFunction("vkGetPipelineExecutablePropertiesKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallGetPipelineExecutableStatisticsKHR(VkDevice                        device, const VkPipelineExecutableInfoKHR*  pExecutableInfo, uint32_t* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics) { PreCallApiFunction("vkGetPipelineExecutableStatisticsKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetPipelineExecutableStatisticsKHR(VkDevice                        device, const VkPipelineExecutableInfoKHR*  pExecutableInfo, uint32_t* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics, VkResult result) { PostCallApiFunction("vkGetPipelineExecutableStatisticsKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallGetPipelineExecutableInternalRepresentationsKHR(VkDevice                        device, const VkPipelineExecutableInfoKHR*  pExecutableInfo, uint32_t* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations) { PreCallApiFunction("vkGetPipelineExecutableInternalRepresentationsKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetPipelineExecutableInternalRepresentationsKHR(VkDevice                        device, const VkPipelineExecutableInfoKHR*  pExecutableInfo, uint32_t* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations, VkResult result) { PostCallApiFunction("vkGetPipelineExecutableInternalRepresentationsKHR", result); return VK_SUCCESS; };
        virtual void PreCallCmdCopyBuffer2KHR(VkCommandBuffer commandBuffer, const VkCopyBufferInfo2KHR* pCopyBufferInfo) { PreCallApiFunction("vkCmdCopyBuffer2KHR");};
        virtual void PostCallCmdCopyBuffer2KHR(VkCommandBuffer commandBuffer, const VkCopyBufferInfo2KHR* pCopyBufferInfo) { PostCallApiFunction("vkCmdCopyBuffer2KHR");};
        virtual void PreCallCmdCopyImage2KHR(VkCommandBuffer commandBuffer, const VkCopyImageInfo2KHR* pCopyImageInfo) { PreCallApiFunction("vkCmdCopyImage2KHR");};
        virtual void PostCallCmdCopyImage2KHR(VkCommandBuffer commandBuffer, const VkCopyImageInfo2KHR* pCopyImageInfo) { PostCallApiFunction("vkCmdCopyImage2KHR");};
        virtual void PreCallCmdCopyBufferToImage2KHR(VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo) { PreCallApiFunction("vkCmdCopyBufferToImage2KHR");};
        virtual void PostCallCmdCopyBufferToImage2KHR(VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo) { PostCallApiFunction("vkCmdCopyBufferToImage2KHR");};
        virtual void PreCallCmdCopyImageToBuffer2KHR(VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo) { PreCallApiFunction("vkCmdCopyImageToBuffer2KHR");};
        virtual void PostCallCmdCopyImageToBuffer2KHR(VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo) { PostCallApiFunction("vkCmdCopyImageToBuffer2KHR");};
        virtual void PreCallCmdBlitImage2KHR(VkCommandBuffer commandBuffer, const VkBlitImageInfo2KHR* pBlitImageInfo) { PreCallApiFunction("vkCmdBlitImage2KHR");};
        virtual void PostCallCmdBlitImage2KHR(VkCommandBuffer commandBuffer, const VkBlitImageInfo2KHR* pBlitImageInfo) { PostCallApiFunction("vkCmdBlitImage2KHR");};
        virtual void PreCallCmdResolveImage2KHR(VkCommandBuffer commandBuffer, const VkResolveImageInfo2KHR* pResolveImageInfo) { PreCallApiFunction("vkCmdResolveImage2KHR");};
        virtual void PostCallCmdResolveImage2KHR(VkCommandBuffer commandBuffer, const VkResolveImageInfo2KHR* pResolveImageInfo) { PostCallApiFunction("vkCmdResolveImage2KHR");};
        ...
        virtual VkResult PreCallGetImageViewAddressNVX(VkDevice device, VkImageView imageView, VkImageViewAddressPropertiesNVX* pProperties) { PreCallApiFunction("vkGetImageViewAddressNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallGetImageViewAddressNVX(VkDevice device, VkImageView imageView, VkImageViewAddressPropertiesNVX* pProperties, VkResult result) { PostCallApiFunction("vkGetImageViewAddressNVX", result); return VK_SUCCESS; };
        ...
        virtual void PreCallDestroyAccelerationStructureKHR(VkDevice device, VkAccelerationStructureKHR accelerationStructure, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyAccelerationStructureKHR");};
        virtual void PostCallDestroyAccelerationStructureKHR(VkDevice device, VkAccelerationStructureKHR accelerationStructure, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyAccelerationStructureKHR");};
        virtual void PreCallDestroyAccelerationStructureNV(VkDevice device, VkAccelerationStructureKHR accelerationStructure, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyAccelerationStructureNV");};
        virtual void PostCallDestroyAccelerationStructureNV(VkDevice device, VkAccelerationStructureKHR accelerationStructure, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyAccelerationStructureNV");};
        ...
        virtual VkResult PreCallBindAccelerationStructureMemoryKHR(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoKHR* pBindInfos) { PreCallApiFunction("vkBindAccelerationStructureMemoryKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallBindAccelerationStructureMemoryKHR(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoKHR* pBindInfos, VkResult result) { PostCallApiFunction("vkBindAccelerationStructureMemoryKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallBindAccelerationStructureMemoryNV(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoKHR* pBindInfos) { PreCallApiFunction("vkBindAccelerationStructureMemoryNV"); return VK_SUCCESS; };
        virtual VkResult PostCallBindAccelerationStructureMemoryNV(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoKHR* pBindInfos, VkResult result) { PostCallApiFunction("vkBindAccelerationStructureMemoryNV", result); return VK_SUCCESS; };
        ...
        virtual void PreCallCmdCopyAccelerationStructureNV(VkCommandBuffer commandBuffer, VkAccelerationStructureKHR dst, VkAccelerationStructureKHR src, VkCopyAccelerationStructureModeKHR mode) { PreCallApiFunction("vkCmdCopyAccelerationStructureNV");};
        virtual void PostCallCmdCopyAccelerationStructureNV(VkCommandBuffer commandBuffer, VkAccelerationStructureKHR dst, VkAccelerationStructureKHR src, VkCopyAccelerationStructureModeKHR mode) { PostCallApiFunction("vkCmdCopyAccelerationStructureNV");};
        ...
        virtual VkResult PreCallGetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) { PreCallApiFunction("vkGetRayTracingShaderGroupHandlesKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData, VkResult result) { PostCallApiFunction("vkGetRayTracingShaderGroupHandlesKHR", result); return VK_SUCCESS; };
        ...
        virtual VkResult PreCallGetAccelerationStructureHandleNV(VkDevice device, VkAccelerationStructureKHR accelerationStructure, size_t dataSize, void* pData) { PreCallApiFunction("vkGetAccelerationStructureHandleNV"); return VK_SUCCESS; };
        virtual VkResult PostCallGetAccelerationStructureHandleNV(VkDevice device, VkAccelerationStructureKHR accelerationStructure, size_t dataSize, void* pData, VkResult result) { PostCallApiFunction("vkGetAccelerationStructureHandleNV", result); return VK_SUCCESS; };
        virtual void PreCallCmdWriteAccelerationStructuresPropertiesKHR(VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery) { PreCallApiFunction("vkCmdWriteAccelerationStructuresPropertiesKHR");};
        virtual void PostCallCmdWriteAccelerationStructuresPropertiesKHR(VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery) { PostCallApiFunction("vkCmdWriteAccelerationStructuresPropertiesKHR");};
        virtual void PreCallCmdWriteAccelerationStructuresPropertiesNV(VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery) { PreCallApiFunction("vkCmdWriteAccelerationStructuresPropertiesNV");};
        virtual void PostCallCmdWriteAccelerationStructuresPropertiesNV(VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery) { PostCallApiFunction("vkCmdWriteAccelerationStructuresPropertiesNV");};
...
#endif
        virtual VkDeviceAddress PreCallGetBufferDeviceAddressEXT(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PreCallApiFunction("vkGetBufferDeviceAddressEXT"); return 0; };
        virtual VkDeviceAddress PostCallGetBufferDeviceAddressEXT(VkDevice device, const VkBufferDeviceAddressInfo* pInfo){ PostCallApiFunction("vkGetBufferDeviceAddressEXT"); return 0; };
        virtual VkResult PreCallGetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolPropertiesEXT* pToolProperties) { PreCallApiFunction("vkGetPhysicalDeviceToolPropertiesEXT"); return VK_SUCCESS; };
        virtual VkResult PostCallGetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolPropertiesEXT* pToolProperties, VkResult result) { PostCallApiFunction("vkGetPhysicalDeviceToolPropertiesEXT", result); return VK_SUCCESS; };
        ...
        virtual void PreCallCmdSetLineStippleEXT(VkCommandBuffer commandBuffer, uint32_t lineStippleFactor, uint16_t lineStipplePattern) { PreCallApiFunction("vkCmdSetLineStippleEXT");};
        virtual void PostCallCmdSetLineStippleEXT(VkCommandBuffer commandBuffer, uint32_t lineStippleFactor, uint16_t lineStipplePattern) { PostCallApiFunction("vkCmdSetLineStippleEXT");};
        ...
        virtual void PreCallCmdSetCullModeEXT(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode) { PreCallApiFunction("vkCmdSetCullModeEXT");};
        virtual void PostCallCmdSetCullModeEXT(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode) { PostCallApiFunction("vkCmdSetCullModeEXT");};
        virtual void PreCallCmdSetFrontFaceEXT(VkCommandBuffer commandBuffer, VkFrontFace frontFace) { PreCallApiFunction("vkCmdSetFrontFaceEXT");};
        virtual void PostCallCmdSetFrontFaceEXT(VkCommandBuffer commandBuffer, VkFrontFace frontFace) { PostCallApiFunction("vkCmdSetFrontFaceEXT");};
        virtual void PreCallCmdSetPrimitiveTopologyEXT(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology) { PreCallApiFunction("vkCmdSetPrimitiveTopologyEXT");};
        virtual void PostCallCmdSetPrimitiveTopologyEXT(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology) { PostCallApiFunction("vkCmdSetPrimitiveTopologyEXT");};
        virtual void PreCallCmdSetViewportWithCountEXT(VkCommandBuffer commandBuffer, uint32_t viewportCount, const VkViewport* pViewports) { PreCallApiFunction("vkCmdSetViewportWithCountEXT");};
        virtual void PostCallCmdSetViewportWithCountEXT(VkCommandBuffer commandBuffer, uint32_t viewportCount, const VkViewport* pViewports) { PostCallApiFunction("vkCmdSetViewportWithCountEXT");};
        virtual void PreCallCmdSetScissorWithCountEXT(VkCommandBuffer commandBuffer, uint32_t scissorCount, const VkRect2D* pScissors) { PreCallApiFunction("vkCmdSetScissorWithCountEXT");};
        virtual void PostCallCmdSetScissorWithCountEXT(VkCommandBuffer commandBuffer, uint32_t scissorCount, const VkRect2D* pScissors) { PostCallApiFunction("vkCmdSetScissorWithCountEXT");};
        virtual void PreCallCmdBindVertexBuffers2EXT(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets, const VkDeviceSize* pSizes, const VkDeviceSize* pStrides) { PreCallApiFunction("vkCmdBindVertexBuffers2EXT");};
        virtual void PostCallCmdBindVertexBuffers2EXT(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets, const VkDeviceSize* pSizes, const VkDeviceSize* pStrides) { PostCallApiFunction("vkCmdBindVertexBuffers2EXT");};
        virtual void PreCallCmdSetDepthTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthTestEnable) { PreCallApiFunction("vkCmdSetDepthTestEnableEXT");};
        virtual void PostCallCmdSetDepthTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthTestEnable) { PostCallApiFunction("vkCmdSetDepthTestEnableEXT");};
        virtual void PreCallCmdSetDepthWriteEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable) { PreCallApiFunction("vkCmdSetDepthWriteEnableEXT");};
        virtual void PostCallCmdSetDepthWriteEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable) { PostCallApiFunction("vkCmdSetDepthWriteEnableEXT");};
        virtual void PreCallCmdSetDepthCompareOpEXT(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp) { PreCallApiFunction("vkCmdSetDepthCompareOpEXT");};
        virtual void PostCallCmdSetDepthCompareOpEXT(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp) { PostCallApiFunction("vkCmdSetDepthCompareOpEXT");};
        virtual void PreCallCmdSetDepthBoundsTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable) { PreCallApiFunction("vkCmdSetDepthBoundsTestEnableEXT");};
        virtual void PostCallCmdSetDepthBoundsTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable) { PostCallApiFunction("vkCmdSetDepthBoundsTestEnableEXT");};
        virtual void PreCallCmdSetStencilTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable) { PreCallApiFunction("vkCmdSetStencilTestEnableEXT");};
        virtual void PostCallCmdSetStencilTestEnableEXT(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable) { PostCallApiFunction("vkCmdSetStencilTestEnableEXT");};
        virtual void PreCallCmdSetStencilOpEXT(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp) { PreCallApiFunction("vkCmdSetStencilOpEXT");};
        virtual void PostCallCmdSetStencilOpEXT(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp) { PostCallApiFunction("vkCmdSetStencilOpEXT");};
        virtual void PreCallGetGeneratedCommandsMemoryRequirementsNV(VkDevice device, const VkGeneratedCommandsMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2* pMemoryRequirements) { PreCallApiFunction("vkGetGeneratedCommandsMemoryRequirementsNV");};
        virtual void PostCallGetGeneratedCommandsMemoryRequirementsNV(VkDevice device, const VkGeneratedCommandsMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2* pMemoryRequirements) { PostCallApiFunction("vkGetGeneratedCommandsMemoryRequirementsNV");};
        virtual void PreCallCmdPreprocessGeneratedCommandsNV(VkCommandBuffer commandBuffer, const VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) { PreCallApiFunction("vkCmdPreprocessGeneratedCommandsNV");};
        virtual void PostCallCmdPreprocessGeneratedCommandsNV(VkCommandBuffer commandBuffer, const VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) { PostCallApiFunction("vkCmdPreprocessGeneratedCommandsNV");};
        virtual void PreCallCmdExecuteGeneratedCommandsNV(VkCommandBuffer commandBuffer, VkBool32 isPreprocessed, const VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) { PreCallApiFunction("vkCmdExecuteGeneratedCommandsNV");};
        virtual void PostCallCmdExecuteGeneratedCommandsNV(VkCommandBuffer commandBuffer, VkBool32 isPreprocessed, const VkGeneratedCommandsInfoNV* pGeneratedCommandsInfo) { PostCallApiFunction("vkCmdExecuteGeneratedCommandsNV");};
        virtual void PreCallCmdBindPipelineShaderGroupNV(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline, uint32_t groupIndex) { PreCallApiFunction("vkCmdBindPipelineShaderGroupNV");};
        virtual void PostCallCmdBindPipelineShaderGroupNV(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline, uint32_t groupIndex) { PostCallApiFunction("vkCmdBindPipelineShaderGroupNV");};
        virtual VkResult PreCallCreateIndirectCommandsLayoutNV(VkDevice device, const VkIndirectCommandsLayoutCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNV* pIndirectCommandsLayout) { PreCallApiFunction("vkCreateIndirectCommandsLayoutNV"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateIndirectCommandsLayoutNV(VkDevice device, const VkIndirectCommandsLayoutCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNV* pIndirectCommandsLayout, VkResult result) { PostCallApiFunction("vkCreateIndirectCommandsLayoutNV", result); return VK_SUCCESS; };
        virtual void PreCallDestroyIndirectCommandsLayoutNV(VkDevice device, VkIndirectCommandsLayoutNV indirectCommandsLayout, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyIndirectCommandsLayoutNV");};
        virtual void PostCallDestroyIndirectCommandsLayoutNV(VkDevice device, VkIndirectCommandsLayoutNV indirectCommandsLayout, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyIndirectCommandsLayoutNV");};
        virtual VkResult PreCallCreatePrivateDataSlotEXT(VkDevice device, const VkPrivateDataSlotCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlotEXT* pPrivateDataSlot) { PreCallApiFunction("vkCreatePrivateDataSlotEXT"); return VK_SUCCESS; };
        virtual VkResult PostCallCreatePrivateDataSlotEXT(VkDevice device, const VkPrivateDataSlotCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlotEXT* pPrivateDataSlot, VkResult result) { PostCallApiFunction("vkCreatePrivateDataSlotEXT", result); return VK_SUCCESS; };
        virtual void PreCallDestroyPrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotEXT privateDataSlot, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyPrivateDataSlotEXT");};
        virtual void PostCallDestroyPrivateDataSlotEXT(VkDevice device, VkPrivateDataSlotEXT privateDataSlot, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyPrivateDataSlotEXT");};
        virtual VkResult PreCallSetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t data) { PreCallApiFunction("vkSetPrivateDataEXT"); return VK_SUCCESS; };
        virtual VkResult PostCallSetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t data, VkResult result) { PostCallApiFunction("vkSetPrivateDataEXT", result); return VK_SUCCESS; };
        virtual void PreCallGetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t* pData) { PreCallApiFunction("vkGetPrivateDataEXT");};
        virtual void PostCallGetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t* pData) { PostCallApiFunction("vkGetPrivateDataEXT");};
#ifdef VK_USE_PLATFORM_DIRECTFB_EXT
        virtual VkResult PreCallCreateDirectFBSurfaceEXT(VkInstance instance, const VkDirectFBSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) { PreCallApiFunction("vkCreateDirectFBSurfaceEXT"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateDirectFBSurfaceEXT(VkInstance instance, const VkDirectFBSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface, VkResult result) { PostCallApiFunction("vkCreateDirectFBSurfaceEXT", result); return VK_SUCCESS; };
#endif
#ifdef VK_USE_PLATFORM_DIRECTFB_EXT
        virtual VkBool32 PreCallGetPhysicalDeviceDirectFBPresentationSupportEXT(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, IDirectFB* dfb) { PreCallApiFunction("vkGetPhysicalDeviceDirectFBPresentationSupportEXT"); return VK_TRUE; };
        virtual VkBool32 PostCallGetPhysicalDeviceDirectFBPresentationSupportEXT(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, IDirectFB* dfb) { PostCallApiFunction("vkGetPhysicalDeviceDirectFBPresentationSupportEXT"); return VK_TRUE; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCreateAccelerationStructureKHR(VkDevice                                           device, const VkAccelerationStructureCreateInfoKHR*        pCreateInfo, const VkAllocationCallbacks*       pAllocator, VkAccelerationStructureKHR*                        pAccelerationStructure) { PreCallApiFunction("vkCreateAccelerationStructureKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateAccelerationStructureKHR(VkDevice                                           device, const VkAccelerationStructureCreateInfoKHR*        pCreateInfo, const VkAllocationCallbacks*       pAllocator, VkAccelerationStructureKHR*                        pAccelerationStructure, VkResult result) { PostCallApiFunction("vkCreateAccelerationStructureKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallGetAccelerationStructureMemoryRequirementsKHR(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) { PreCallApiFunction("vkGetAccelerationStructureMemoryRequirementsKHR");};
        virtual void PostCallGetAccelerationStructureMemoryRequirementsKHR(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) { PostCallApiFunction("vkGetAccelerationStructureMemoryRequirementsKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdBuildAccelerationStructureKHR(VkCommandBuffer                                    commandBuffer, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos) { PreCallApiFunction("vkCmdBuildAccelerationStructureKHR");};
        virtual void PostCallCmdBuildAccelerationStructureKHR(VkCommandBuffer                                    commandBuffer, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos) { PostCallApiFunction("vkCmdBuildAccelerationStructureKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdBuildAccelerationStructureIndirectKHR(VkCommandBuffer                  commandBuffer, const VkAccelerationStructureBuildGeometryInfoKHR* pInfo, VkBuffer                                           indirectBuffer, VkDeviceSize                                       indirectOffset, uint32_t                                           indirectStride) { PreCallApiFunction("vkCmdBuildAccelerationStructureIndirectKHR");};
        virtual void PostCallCmdBuildAccelerationStructureIndirectKHR(VkCommandBuffer                  commandBuffer, const VkAccelerationStructureBuildGeometryInfoKHR* pInfo, VkBuffer                                           indirectBuffer, VkDeviceSize                                       indirectOffset, uint32_t                                           indirectStride) { PostCallApiFunction("vkCmdBuildAccelerationStructureIndirectKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallBuildAccelerationStructureKHR(VkDevice                                           device, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos) { PreCallApiFunction("vkBuildAccelerationStructureKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallBuildAccelerationStructureKHR(VkDevice                                           device, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildOffsetInfoKHR* const* ppOffsetInfos, VkResult result) { PostCallApiFunction("vkBuildAccelerationStructureKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCopyAccelerationStructureKHR(VkDevice device, const VkCopyAccelerationStructureInfoKHR* pInfo) { PreCallApiFunction("vkCopyAccelerationStructureKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCopyAccelerationStructureKHR(VkDevice device, const VkCopyAccelerationStructureInfoKHR* pInfo, VkResult result) { PostCallApiFunction("vkCopyAccelerationStructureKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCopyAccelerationStructureToMemoryKHR(VkDevice device, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) { PreCallApiFunction("vkCopyAccelerationStructureToMemoryKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCopyAccelerationStructureToMemoryKHR(VkDevice device, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo, VkResult result) { PostCallApiFunction("vkCopyAccelerationStructureToMemoryKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCopyMemoryToAccelerationStructureKHR(VkDevice device, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) { PreCallApiFunction("vkCopyMemoryToAccelerationStructureKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCopyMemoryToAccelerationStructureKHR(VkDevice device, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo, VkResult result) { PostCallApiFunction("vkCopyMemoryToAccelerationStructureKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallWriteAccelerationStructuresPropertiesKHR(VkDevice device, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType  queryType, size_t       dataSize, void* pData, size_t stride) { PreCallApiFunction("vkWriteAccelerationStructuresPropertiesKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallWriteAccelerationStructuresPropertiesKHR(VkDevice device, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType  queryType, size_t       dataSize, void* pData, size_t stride, VkResult result) { PostCallApiFunction("vkWriteAccelerationStructuresPropertiesKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdCopyAccelerationStructureKHR(VkCommandBuffer commandBuffer, const VkCopyAccelerationStructureInfoKHR* pInfo) { PreCallApiFunction("vkCmdCopyAccelerationStructureKHR");};
        virtual void PostCallCmdCopyAccelerationStructureKHR(VkCommandBuffer commandBuffer, const VkCopyAccelerationStructureInfoKHR* pInfo) { PostCallApiFunction("vkCmdCopyAccelerationStructureKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdCopyAccelerationStructureToMemoryKHR(VkCommandBuffer commandBuffer, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) { PreCallApiFunction("vkCmdCopyAccelerationStructureToMemoryKHR");};
        virtual void PostCallCmdCopyAccelerationStructureToMemoryKHR(VkCommandBuffer commandBuffer, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) { PostCallApiFunction("vkCmdCopyAccelerationStructureToMemoryKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdCopyMemoryToAccelerationStructureKHR(VkCommandBuffer commandBuffer, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) { PreCallApiFunction("vkCmdCopyMemoryToAccelerationStructureKHR");};
        virtual void PostCallCmdCopyMemoryToAccelerationStructureKHR(VkCommandBuffer commandBuffer, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) { PostCallApiFunction("vkCmdCopyMemoryToAccelerationStructureKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdTraceRaysKHR(VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, uint32_t width, uint32_t height, uint32_t depth) { PreCallApiFunction("vkCmdTraceRaysKHR");};
        virtual void PostCallCmdTraceRaysKHR(VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, uint32_t width, uint32_t height, uint32_t depth) { PostCallApiFunction("vkCmdTraceRaysKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallCreateRayTracingPipelinesKHR(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) { PreCallApiFunction("vkCreateRayTracingPipelinesKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateRayTracingPipelinesKHR(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines, VkResult result) { PostCallApiFunction("vkCreateRayTracingPipelinesKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkDeviceAddress PreCallGetAccelerationStructureDeviceAddressKHR(VkDevice device, const VkAccelerationStructureDeviceAddressInfoKHR* pInfo){ PreCallApiFunction("vkGetAccelerationStructureDeviceAddressKHR"); return 0; };
        virtual VkDeviceAddress PostCallGetAccelerationStructureDeviceAddressKHR(VkDevice device, const VkAccelerationStructureDeviceAddressInfoKHR* pInfo){ PostCallApiFunction("vkGetAccelerationStructureDeviceAddressKHR"); return 0; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallGetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) { PreCallApiFunction("vkGetRayTracingCaptureReplayShaderGroupHandlesKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData, VkResult result) { PostCallApiFunction("vkGetRayTracingCaptureReplayShaderGroupHandlesKHR", result); return VK_SUCCESS; };
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual void PreCallCmdTraceRaysIndirectKHR(VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, VkBuffer buffer, VkDeviceSize offset) { PreCallApiFunction("vkCmdTraceRaysIndirectKHR");};
        virtual void PostCallCmdTraceRaysIndirectKHR(VkCommandBuffer commandBuffer, const VkStridedBufferRegionKHR* pRaygenShaderBindingTable, const VkStridedBufferRegionKHR* pMissShaderBindingTable, const VkStridedBufferRegionKHR* pHitShaderBindingTable, const VkStridedBufferRegionKHR* pCallableShaderBindingTable, VkBuffer buffer, VkDeviceSize offset) { PostCallApiFunction("vkCmdTraceRaysIndirectKHR");};
#endif
#ifdef VK_ENABLE_BETA_EXTENSIONS
        virtual VkResult PreCallGetDeviceAccelerationStructureCompatibilityKHR(VkDevice device, const VkAccelerationStructureVersionKHR* version) { PreCallApiFunction("vkGetDeviceAccelerationStructureCompatibilityKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallGetDeviceAccelerationStructureCompatibilityKHR(VkDevice device, const VkAccelerationStructureVersionKHR* version, VkResult result) { PostCallApiFunction("vkGetDeviceAccelerationStructureCompatibilityKHR", result); return VK_SUCCESS; };
#endif
};
